...
import skvideo
# skvideo.setFFmpegPath('/home/ido/Deep/tools/ffmpeg/')
import skvideo.io
...
class AudioDataset(Dataset):
    ...
    def __init__(self, DataDir, timeDepth, is_train):
        ...
        raw_audio = [x for x in sorted(os.listdir(self.DataDir)) if ".wav" in x]
...
class VideoDataset(Dataset):
    ...
    def __init__(self, DataDir, timeDepth, is_train):
        ...
        raw_video = [x for x in sorted(os.listdir(self.DataDir)) if ".avi" in x]
